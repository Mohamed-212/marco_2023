    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <?php if ($this->permission->method('add_ofloan_person', 'create')->access()) { ?>
                    <a href="<?php echo base_url('hrm/loan/bdtask_add_office_loan_person') ?>" class="btn btn-info m-b-5 m-r-2"><i
                                class="ti-plus"> </i> <?php echo display('add_person') ?> </a>
                <?php } ?>
                <?php if ($this->permission->method('add_loan_payment', 'create')->access()) { ?>
                    <a href="<?php echo base_url('hrm/loan/bdtask_add_office_loan_payment') ?>" class="btn btn-success m-b-5 m-r-2"><i
                                class="ti-plus"> </i> <?php echo display('add_payment') ?> </a>
                <?php } ?>
                <?php if ($this->permission->method('manage_ofln_person', 'read')->access()) { ?>
                    <a href="<?php echo base_url('hrm/loan/manage_ofln_person') ?>" class="btn btn-primary m-b-5 m-r-2"><i
                                class="ti-plus"> </i> <?php echo display('manage_person') ?> </a>
                <?php } ?>
                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control" required name="person_id" id="nameofficeloanperson"
                                        tabindex="1">
                        ...
                        <div class="form-group row" id="payment_from">
                            ...
                            <div class="col-sm-6">
                                <select name="paytype" class="form-control" required=""
                                        onchange="bank_paymetExpense(this.value)" tabindex="3">
