        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <?php if ($this->permission->method('manage_ofln_person', 'read')->access()) { ?>
                    <a href="<?php echo base_url('hrm/loan/manage_ofln_person') ?>" class="btn btn-info m-b-5 m-r-2"><i
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="name" id="name" required=""
                                       placeholder="<?php echo display('name') ?>" tabindex="1"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="number" class="form-control" name="phone" id="phone"
                                       placeholder="<?php echo display('phone') ?>" tabindex="2"
                                       data-validation="number" data-validation-allowing="negative,number" input
                                       name="color" data-validation="number" datavalidation-ignore="$"
                                       required="required"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <textarea class="form-control" name="address" id="address"
                                          placeholder="<?php echo display('address') ?>" tabindex="3"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="submit" id="add-deposit" class="btn btn-success" name="add-deposit"
                                       value="<?php echo display('save') ?>" tabindex="5"/>
                            </div>
                        </div>
                    </div>
                    <?php echo form_close() ?>
