    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <?php } ?>
                <?php if ($this->permission->method('add_office_loan', 'create')->access()) { ?>
                    <a href="<?php echo base_url('hrm/loan/bdtask_add_office_loan') ?>" class="btn btn-success m-b-5 m-r-2"><i
                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control" name="person_id" required id="nameofficeloanperson"
                                        tabindex="1">
