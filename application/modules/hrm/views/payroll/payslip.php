                        ...
                        <div class="panel-body" id="payslip">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <img src="<?php echo(!empty($settingss[0]['logo']) ? base_url() . $settingss[0]['logo'] : '') ?>"
                                                     width="250px;" alt=""></td>
                                            <td class="text-center payslipadd">
                                                <address class="margin-top10">
                                                    ...
                                                    <?php echo(!empty($company[0]['address']) ? $company[0]['address'] : 'Demo Address') ?>
                                                    <br>
                                    ...
                                    <table>
                                        <div id="details">
                                            <div class="scope-entry">
                                                <div class="title"><?php echo display('employee_name') ?>
                                                    :<?php echo $paymentdata[0]['first_name'] . ' ' . $paymentdata[0]['last_name'] ?></div>
                                                <div class="title"><?php echo display('designation') ?>
                                                    : <?php echo $paymentdata[0]['position_name'] ?></div>
                                                <div class="title"><?php echo display('salary_date') ?>
                                                    : <?php echo $paymentdata[0]['payment_date'] ?></div>
                                        ...
                                        <tr>
                                            <td class="left-panel borderright">
                                                <table class="" width="100%">
                                                    ...
                                                    <thead>
                                                    <tr class="employee">
                                                        <th class="name text-center border-bottom"
                                                            colspan="2"><?php echo display('earnings'); ?></th>
                                                    ...
                                                    <tr class="entry nti">
                                                        ...
                                                        <td class="value">
                                                            <b><?php echo number_format($totalAddition + $basicsal, 2); ?></b>
                                                        </td>
                                                    </tr>
                                            ...
                                            <td class="right-panel">
                                                <table class="" width="100%">
                                                    ...
                                                    <tr class="employee">
                                                        <th class="name text-center border-bottom"
                                                            colspan="2"><?php echo display('deduction'); ?></th>
                                                    ...
                                                    <tr class="entry nti">
                                                        ...
                                                        <td class="value">
                                                            <b><?php echo number_format($totalDeduction + (!empty($totaltax) ? $totaltax : 0), 2); ?></b>
                                                        </td>
                                                    </tr>
                                    ...
                                    <table class="table">
                                        ...
                                        <tr class="details">
                                            ...
                                            <td class="value text-right">
                                                <b><?php echo $paymentdata[0]['total_salary'] ?></b></td>
                                            </tbody>
                                        </tr>
                            ...
                            <div class="row paddingbottom">
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-6 text-left"><b><?php echo display('ref_number') ?>:
                                            .........</b></div>
