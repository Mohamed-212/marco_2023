...
<div class="lost-password">
    ...
    <h4 class="mb-25 text-center"><?php echo display('create_your_account')?></h4>
        ...
        <div class="form-group">
            <label class="control-label" for="first_name"><?php echo display('first_name')?><span class="text-danger" title="required">*</span></label>
        ...
        <div class="form-group">
            ...
            <p class="d-inline-block pull-right mt-8 already_member"><?php echo display('already_member')?>
