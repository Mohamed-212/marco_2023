...
//Get Update file
define('MIN_VERSION', file_get_contents('https://update.bdtask.com/isshue_v5/autoupdate/update_min_version'));
//Get Update file
define('MAX_VERSION', file_get_contents('https://update.bdtask.com/isshue_v5/autoupdate/update_max_version'));
//Update List
define('UPDATE_LIST','https://update.bdtask.com/isshue_v5/autoupdate/update_list');

//Get Update file
define('UPDATE_URL','https://update.bdtask.com/isshue_v5/autoupdate');
// Get latest version info
define('UPDATE_INFO_URL','https://update.bdtask.com/isshue_v5/autoupdate/update_info');
// CRM temporary path
