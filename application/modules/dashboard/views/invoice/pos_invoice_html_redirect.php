        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center"
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th style="border: 1px solid #000;"><?php echo html_escape($item['discount']); ?></th>
                    <?php
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center"
            ...
            <tbody>
                ...
                <tr>
                    ...
                    ?>
                    <th style="text-align: left;padding: 3px 10px 3px 0px">Items with VAT</th>
                    <th style="text-align: center;">
                        <?php echo (($position == 0) ? $currency . "" . ($i_total_discount_price_amount + $taxAmount) : ($i_total_discount_price_amount + $taxAmount) . "" . $currency) ?>
                    </th>
                </tr>
                <tr>
                    <th style="text-align: left;padding: 3px 10px 3px 0px">Items without VAT</th>
                    <th style="text-align: center;">
                        <?php echo (($position == 0) ? $currency . "" . $i_total_discount_price_amount : $i_total_discount_price_amount . "" . $currency) ?>
                    </th>
                </tr>
