                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            <label for="theme_name" class="col-sm-3 col-form-label"><?php echo display('themes') ?>
                            </label>
                            <div class="col-sm-6">
                                <select name="theme_name" id="theme_name" class="form-control">
                                    ...
                                    ?>
                                    <option value="<?php echo html_escape($item->name); ?>"
                                        <?php echo (($active_theme == $item->name) ? 'selected' : '') ?>>
                                        <?php echo ucwords(str_replace('_', ' ', $item->name)); ?></option>
                                    <?php }
                                    } ?>
                                </select>
                            </div>
