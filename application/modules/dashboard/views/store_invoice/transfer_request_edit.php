        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('dashboard/store_invoice/transfer_update/' . $trasfer_id, array('class' => 'form-vertical', 'id' => 'validate')) ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control" id="transfer_from" name="transfer_from"
                                            ...
                                            ?>
                                            <option value="<?php echo html_escape($store_item['store_id']); ?>"
                                                <?php echo (($transinfo['transfer_from'] == $store_item['store_id']) ? 'selected' : '') ?>>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            ...
                                            <input type="number" id="avl_qntt_<?php echo $index; ?>"
                                                ...
                                                value="<?php echo html_escape($prod_stock) ?>" readonly />
                                        </td>
                                        <td class="text-right">
