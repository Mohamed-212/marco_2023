                ...
                <div class="panel-body">
                    <div class="row height_200">
                        <div class="col-sm-8 inv_logo_div">
                            <img src="<?php echo  base_url().(!empty(html_escape($invoice_logo))?$invoice_logo:'assets/img/icons/default.jpg')?>" class="inv_logo2" alt="">
                            <br>
                        ...
                        <div class="col-sm-4 text-left quotation_div order_div">
                        ...
                        <table class="table table-striped table-bordered cizgili" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{variant_name} {variant_color}</td>
