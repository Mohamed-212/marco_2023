        ...
        <div class="row">
            <div class="col-sm-8">
                ...
                <div class="input-group">
                    <input type="text" id="product_name" class="form-control search-field" dir="ltr" value="" name="s"
                    ...
                    <div class="input-group-addon search-categories">
                        <select name='category_id' id='category_id' class='postform resizeselect form-control'>
                            ...
                            <option value="<?php echo html_escape($category->category_id) ?>">
                                <?php echo html_escape($category->category_name) ?></option>
                            <?php
                                }
                            }
                            ?>
                        ...
                        <div class="col-xs-6 col-sm-4 col-md-2 col-p-3">
                            <div class="panel panel-bd product-panel select_product">
                                ...
                                <div class="panel-footer">
                                    <?php echo html_escape($product->product_model . '-' . $product->product_name) ?>
                                </div>
                            </div>
                        </div>
                        <?php
            ...
            <div class="col-sm-4">
                ...
                <div class="panel panel-bd">
                    <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <select id="customer_name" class="form-control" name="customer_id" required="">
                                    ...
                                    <optgroup label="Others">
                                        ...
                                        ?>
                                        <option value="<?php echo html_escape($customer_det->customer_id) ?>">
                                            <?php echo html_escape($customer_det->customer_name) ?></option>
                                        <?php
                                            }
                                        }
                                        ?>
                        ...
                        <div class="form-group">
                            <label for="store_name"><?php echo display('store_name') ?> <span
                                    class="color-red">*</span></label>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="text" id="total_cgst" class="form-control text-right"
                                                name="total_cgst" tabindex="-1" value="0.00" readonly="readonly" /></td>
                                    </tr>
                                    <tr>
                                        <th scope="row"><?php echo display('total_sgst') ?></th>
                                        <td><input type="text" id="total_sgst" class="form-control text-right"
                                                name="total_sgst" tabindex="-1" value="0.00" readonly="readonly" /></td>
                                        <th><?php echo display('total_igst') ?></th>
                                        <td><input type="text" id="total_igst" class="form-control text-right"
                                                name="total_igst" tabindex="-1" value="0.00" readonly="readonly" /></td>
                                    </tr>
                                    <tr>
                                        <th scope="row"><?php echo display('total_discount') ?></th>
                                        <td><input type="text" id="total_discount_ammount"
                                                class="form-control text-right" name="total_discount" tabindex="-1"
                                        ...
                                        <td><input type="text" id="invoice_discount" class="form-control text-right"
                                                name="invoice_discount" tabindex="-1" value="0.00"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" id="grandTotal" tabindex="-1"
                                        ...
                                        <td>
                                            <input type="text" id="paidAmount" onkeyup="invoice_paidamount();"
                                                tabindex="-1" class="form-control text-right" name="paid_amount"
                                                value="0.00" />
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" id="dueAmmount" class="form-control text-right"
                                                name="due_amount" value="0.00" readonly="readonly" /></td>
                                        <th></th>
                                        <td></td>
                                    </tr>
                    ...
                    <div class="panel-footer">
                        <button type="button" class="btn btn-info m-b-5"
                            onclick="printDiv('order_tbl')"><?php echo display('print_order') ?></button>
                        <button type="button" class="btn btn-success m-b-5"
                            onclick="printDiv('bill_tbl')"><?php echo display('print_bill') ?></button>
                        <input class="btn btn-warning m-b-5" value="<?php echo display('full_paid') ?>"
                            onclick="full_paid();" type="button">
                        <button type="button"
                            class="btn btn-purple m-b-5 payment_button"><?php echo display('payment') ?></button>
