            ...
            <div class="col-sm-12 col-md-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <?php echo  form_open_multipart('accounting/accounting/update_credit_voucher') ?>
                        <div class="form-group row">
                            <label for="vo_no"
                                class="col-sm-2 col-form-label"><?php echo display('voucher_no') ?></label>
                            <div class="col-sm-4">
                                <input type="text" name="txtVNo" id="txtVNo"
                                    value="<?php echo $debit_info[0]['VNo']; ?>" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="ac"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="dtpDate" id="dtpDate" class="form-control datepicker"
                                    value="<?php echo $debit_info[0]['VDate']; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <textarea name="txtRemarks" id="txtRemarks"
                                    class="form-control"><?php echo html_escape($debit_info[0]['Narration']); ?></textarea>
                            </div>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="txtCode[]"
                                                ...
                                                id="txtCode_<?php echo $sl; ?>">
                                        </td>
                                        <td>
                                            <input type="number" name="txtAmount[]"
                                                value="<?php echo html_escape($upcrvoucher->Credit) ?>"
