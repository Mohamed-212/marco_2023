...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            ...
            <small><?php echo display('trial_balance_without_opening'); ?></small>
            <ol class="breadcrumb">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="table_data">
                                            <td align="left" bgcolor="<?php echo $bg; ?>">
                                                <a href="javascript:"><?php echo $oResultTr[$i]['HeadCode']; ?></a>
                                            </td>
                                            <td align="left" bgcolor="<?php echo $bg; ?>">
                                        ...
                                        <tr class="table_data">
                                            ...
                                            <td align="right" bgcolor="<?php echo $bg; ?>">
                                                <?php
                                                        $closing1 = ($balance + $oResultTrial->Debit) - $oResultTrial->Credit;
                                                        $TotalClosing += $closing1;
                                                        echo number_format($closing1, 2);
                                                        ?>
                                            </td>
                                        </tr>
                                        <?php
