            ...
            <div class="col-sm-12 col-md-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <?php echo  form_open_multipart('accounting/accounting/update_contra_voucher') ?>
                        ...
                        <div class="form-group row">
                            <label for="txtRemarks" class="col-sm-2 col-form-label">
                                <?php echo display('remark')?>
                            </label>
                            <div class="col-sm-4">
                                <textarea name="txtRemarks" id="txtRemarks" class="form-control">
                                    <?php echo html_escape($voucher_info[0]['Narration']);?>
                                </textarea>
                            </div>
                        </div>
                                ...
                                <tbody id="debitvoucher">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="txtCode[]" class="form-control "
                                                value="<?php echo html_escape($vinfo['COAID']);?>"
                                                id="txtCode_<?php echo $sl?>" readonly></td>
