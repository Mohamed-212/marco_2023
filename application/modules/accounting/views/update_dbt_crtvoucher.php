    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <?php echo  form_open_multipart('accounting/accounting/update_debit_voucher') ?>
                        <div class="form-group row">
                            <label for="vo_no"
                                class="col-sm-2 col-form-label"><?php echo display('voucher_no') ?></label>
                            <div class="col-sm-4">
                                <input type="text" name="txtVNo" id="txtVNo"
                                    value="<?php echo $credit_info[0]['VNo'] ?>" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="ac"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="dtpDate" id="dtpDate" class="form-control datepicker"
                                    value="<?php echo $credit_info[0]['VDate']; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <textarea name="txtRemarks" id="txtRemarks"
                                    class="form-control"><?php echo html_escape($credit_info[0]['Narration']); ?></textarea>
                            </div>
                        </div>
                                        ...
                                        <td class="" width="200">
                                            <select name="cmbCode[]" id="cmbCode_<?php echo $sl; ?>"
                                                ...
                                                <option value="<?php echo $acc1->HeadCode; ?>" <?php if ($debitvoucher->COAID == $acc1->HeadCode) {
                                                    ...
                                                    <?php echo html_escape($acc1->HeadName); ?>
                                                </option>
                                                <?php } ?>
                                            </select>
                                    ...
                                    <tr>
                                        <td>
                                            <input type="button" id="add_more" class="btn btn-info" name="add_more"
                                                onClick="addaccountdbt('debitvoucher');"
                                        ...
                                        <td class="text-right">
                                            <input type="text" id="grandTotal" class="form-control text-right "
                                                name="grand_total" value="<?php echo number_format($total, 2); ?>"
                                                readonly="readonly" />
                                        </td>
                                    </tr>
                                </tfoot>
            ...
            <input type="hidden" id="headoption"
                value="<?php foreach ($acc as $acc2) { ?><option value='<?php echo $acc2->HeadCode; ?>'><?php echo html_escape($acc2->HeadName); ?></option><?php } ?>"
                name="">
        </div>
    </section>
</div>