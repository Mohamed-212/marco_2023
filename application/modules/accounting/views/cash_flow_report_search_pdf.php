                        ...
                        <table border="0" width="100%" style="margin-bottom: 10px;padding-bottom: 0px">
                            <tr>
                                <td align="left" style="border-bottom:2px #333 solid;">
                                    <img src="<?php echo base_url() . (!empty($software_info[0]->logo) ? $software_info[0]->logo : 'assets/img/icons/default.jpg'); ?><?php echo $software_info[0]->logo; ?>"
                                        alt="logo">
                                </td>
                                <td align="left" style="border-bottom:2px #333 solid;">
                        ...
                        <table width="100%" class="table_boxnew" style="padding: 5px">
                            ...
                            <tr>
                                <td align="left" style="padding-left:10px">
                                    <?php echo html_escape($oResultAsset[$i]->HeadName); ?>
                                </td>
                                <td>&nbsp;</td>
                                <td align="right"
                            ...
                            <tr>
                                <td align="left" style="padding-left:10px">
                                    <?php echo html_escape($oResultLiab[$t]->HeadName); ?>
                                </td>
                                <td>&nbsp;</td>
                                <td align="right"
                            ...
                            <tr>
                                <td align="left" style="padding-left:10px">
                                    <?php echo html_escape($oResultFund[$t]->HeadName); ?>
                                </td>
                                <td>&nbsp;</td>
                                <td align="right"
                                    style="padding-right:10px; border-left: solid 1px #000; border-right:solid 1px #000;">
