            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-6">
                                <?php echo form_open('accounting/fiscal_year/edit/'.$iteminfo['id']); ?>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" name="title" id="title" type="text"
                                            ...
                                            value="<?php echo set_value('title', $iteminfo['title']); ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control datepicker" name="start_date" id="start_date"
                                            ...
                                            value="<?php echo set_value('start_date', date('Y-m-d', strtotime($iteminfo['start_date']))); ?>"
                                            autocomplete="off">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control datepicker" name="end_date" id="end_date" type="text"
                                            ...
                                            value="<?php echo set_value('end_date', date('Y-m-d', strtotime($iteminfo['end_date']))); ?>"
                                            autocomplete="off">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-9 col-sm-offset-3">
                                        <button class="btn btn-success"
                                            type="submit"><?php echo display('update');?></button>
                                    </div>
                                </div>
                                <?php echo form_close(); ?>
                            </div>
