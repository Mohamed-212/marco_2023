                ...
                <div class="row" id="">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group row">
                            <label for="date" class="col-sm-4 col-form-label"><?php echo display('gl_head')?><span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-8">

                                <select name="cmbCode" class="form-control" onchange="cmbCode_bankbookonchange()"
                                    id="cmbCode" required="">
                        ...
                        <div class="form-group row">
                            <label for="date" class="col-sm-4 col-form-label">
                                <?php echo display('from_date') ?><span class="text-danger">*</span>
                            </label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            <label for="date" class="col-sm-4 col-form-label">
                                <?php echo display('to_date') ?><span class="text-danger">*</span>
                            </label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group text-right">
                            <button type="submit" name="btnSave" class="btn btn-success w-md m-b-5">
                    ...
                    <div class="">
                        <table class="print-table" width="100%">
                            <tr>
                                <td align="left" class="print-table-tr">
                                    <img src="<?php echo base_url().(!empty($setting->logo)?$setting->logo:'assets/img/icons/default.jpg');?>" alt="logo">
                                </td>
                        ...
                        <table width="100%" class="table table-stripped" cellpadding="1" cellspacing="1">
                            <caption class="text-center">
                                <font size="+1"> <strong><?php echo display('bank_book_report_of')?>
                                        <?php echo (!empty($HeadName)?html_escape($HeadName):'') ?>
                                        (<?php echo display('on')?>
                                        <?php echo (!empty($FromDate)?html_escape($FromDate):''); ?>
                                        <?php echo display('to')?>
                                        <?php echo (!empty($ToDate)?html_escape($ToDate):'');?>)</strong></font>
                            </caption>
                            <tr class="table_data">
                                <td align="center">&nbsp;</td>
                                <td align="center">&nbsp;</td>
                                ...
                                <td colspan="2" align="right">
                                    <b><?php echo display('opening_balance')?></b>
                                </td>
                                <td align="right">
                                    <?php echo html_escape(number_format((!empty($PreBalance)?$PreBalance:0),2,'.',',')); ?>
                                </td>
                            </tr>
                            <tr class="table_head">
                            ...
                            <tr class="table_data">
                                ...
                                {
                                ?>
                                <td height="25" bgcolor="<?php echo html_escape($bg); ?>">
                                    <?php echo $CountingNo++;?>
                                </td>
                                <td align="center" bgcolor="<?php echo html_escape($bg); ?>">
                                    <?php echo html_escape(substr($oResult->rows[$i]['VDate'],0,10));?>
                                </td>
                                <td align="center" bgcolor="<?php echo html_escape($bg); ?>">
                                    <?php
                                ...
                                ?>
                                <td align="center" bgcolor="<?php echo html_escape($bg); ?>">
                                    <?php echo html_escape($oResult->rows[$i]['HeadName']);?>
                                </td>
                                <td align="right" bgcolor="<?php echo html_escape($bg); ?>">
                                    <?php
                                        $TotalDebit += $oResult->rows[$i]['Debit'];
                                        $PreBalance += $oResult->rows[$i]['Debit'];
                                        echo html_escape(number_format($oResult->rows[$i]['Debit'],2,'.',','));
                                    ?>
                                </td>
                                <td align="right" bgcolor="<?php echo $bg; ?>">
                                    <?php
                                        ...
                                        echo html_escape(number_format($oResult->rows[$i]['Credit'],2,'.',','));
                                    ?>
                                </td>
                        ...
                        ?>
                            <tr class="table_data print-footercolor">
                                ...
                                <td align="right" bgcolor="green">
                                    <?php echo html_escape(number_format($TotalDebit,2,'.',',')); ?>
                                </td>
                                <td align="right" bgcolor="green">
                                    <?php echo html_escape(number_format($TotalCredit,2,'.',',')); ?>
                                </td>
                                <td align="right" bgcolor="green">
                                    <?php echo html_escape(number_format((!empty($PreBalance)?$PreBalance:0),2,'.',',')); ?>
                                </td>
