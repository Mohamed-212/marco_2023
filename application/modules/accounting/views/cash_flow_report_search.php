                ...
                <div class="panel-body">
                    <div>
                        <table class="print-table" width="100%">
                            <tr>
                                <td align="left" class="print-table-tr">
                                    <img src="<?php echo base_url() . (!empty($setting->logo) ? $setting->logo : 'assets/img/icons/default.jpg'); ?>"
                                        alt="logo">
                                </td>
                        ...
                        <table width="100%" class="table_boxnew" cellpadding="0" cellspacing="0">
                            <tr>
                                <td colspan="3" align="center"><b><?php echo display('cash_flow_statement'); ?> </b>
                                </td>
                            </tr>
                            <tr class="table_head">
                                <td colspan="3" align="center">
                                    <b>On <?php echo html_escape($dtpFromDate); ?> To
                            ...
                            <tr class="table_head">
                                ...
                                <td width="2%">&nbsp;</td>
                                <td width="30%" align="right" class="cashflowamount">
                                    <b><?php echo display('amount'); ?></b>
                                </td>
                            </tr>
                            <tr class="table_head">
                            ...
                            <tr>
                                <td align="left" class="paddingleftright10">
                                    <strong>Total Opening Cash & Cash Equivalent</strong>
                                </td>
                                <td>&nbsp;</td>
                            ...
                            <tr class="table_head">
                                <td colspan="3" class="padddingwithunderline">
                                    <b>Cashflow from Operating Activities</b>
                                </td>
                            </tr>
                            <?php
                            $TotalCurrAsset = 0;
                            ...
                            <tr>
                                <td align="left" class="paddingleft10px">
                                    <?php echo html_escape($oResultCurrAsset[$s]->HeadName); ?>
                                </td>
                                <td>&nbsp;</td>
                                <td align="right"
                            ...
                            <tr>
                                <td align="left" class="paddingleftright10"><strong>Cash generated from Operating
                                        Activites before Changing in Opereating Assets &amp; Liabilities</strong></td>
                                <td>&nbsp;</td>
                                <td align="right" class="totalopeninig">
                            ...
                            <tr class="table_head">
                                <td colspan="3" class="padddingwithunderline"><b>Cashflow from Non Operating
                                        Activities</b></td>
                            </tr>
                            <?php
                            $TotalCurrAssetNon = 0;
                            ...
                            <tr>
                                <td align="left" class="paddingleftright10"><strong>Cash generated from Non Operating
                                        Activites before Changing in Opereating Assets &amp; Liabilities</strong></td>
                                <td>&nbsp;</td>
                                <td align="right" class="totalopeninig">
                            ...
                            <tr class="table_head">
                                <td align="left" class="paddingleftright10"><strong>Increase/Decrease in Operating
                                        Assets &amp; Liabilites</strong></td>
                                <td>&nbsp;</td>
                            ...
                            <tr>
                                <td align="left" class="paddingleftright10"><strong>Total Increase/Decrease</strong>
                                </td>
                                <td>&nbsp;</td>
                                <td align="right" class="totalopeninig">
                            ...
                            <tr>
                                <td align="left" class="paddingleftright10"><strong>Net Cash From Operating/Non
                                        Operating Activities</strong></td>
                                <td>&nbsp;</td>
                                <td align="right" class="totalopeninig">
                            ...
                            <tr class="table_head">
                                <td colspan="3" class="padddingwithunderline"><b>Cash Flow from Investing Activities</b>
                                </td>
                            </tr>
                            <?php
                            $TotalNonCurrAsset = 0;
                            ...
                            <tr>
                                <td align="left" class="paddingleftright10">
                                    <strong>Net Cash Used Investing Activities</strong>
                                </td>
                                <td>&nbsp;</td>
                            ...
                            <tr>
                                <td align="left" class="paddingleftright10"><strong>Net Cash Used Financing
                            ...
                            <tr>
                                <td align="left" class="paddingleft10px"><strong>Net Cash Inflow/Outflow (Profit Loss
                            ...
                            <tr class="table_head">
                                <td colspan="3" class="paddingleft10px"><strong>Closing Cash & Cash Equivalent:</strong>
                                </td>
                            </tr>
                            <?php
                            ...
                            <tr>
                                <td align="left" class="paddingleftright10"><strong>Total Closing Cash & Cash
                        ...
                        <table width="100%" cellpadding="1" cellspacing="20">
                            <tr>
                                <td width="20%" class="footersignature" align="center">
                                    <?php echo display('prepared_by') ?></td>
                                <td width="20%" class="footersignature" align="center"><?php echo display('accounts') ?>
                                </td>
                                <td width="20%" class="footersignature" align="center">
                                    <?php echo display('authorized_signature') ?></td>
                                <td width="20%" class="footersignature" align='center'><?php echo display('chairman') ?>
                                </td>
                            </tr>
                        </table>
                    </div>
