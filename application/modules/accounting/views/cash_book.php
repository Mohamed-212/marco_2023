        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <input type="text" name="dtpFromDate"
                    value="<?php echo (!empty($FromDate) ? html_escape($FromDate) : date('Y-m-d')) ?>"
                    placeholder="<?php echo display('from_date') ?>" class="datepicker form-control" required="">
                <label class="select"><?php echo display('to_date') ?><span class="text-danger">*</span></label>
                <input type="text" name="dtpToDate"
                    value="<?php echo (!empty($ToDate) ? html_escape($ToDate) : date('Y-m-d')) ?>"
                    placeholder="<?php echo display('to_date') ?>" class="datepicker form-control" required="">
                    ...
                    <div>
                        ...
                        <table width="100%" class="table table-stripped" cellpadding="6" cellspacing="1">
                            <caption class="text-center">
                                <font size="+1"> <strong> <?php echo display('cash_book_report') ?>
                                        (<?php echo display('from') ?>
                                        <?php echo (!empty($FromDate) ? html_escape($FromDate) : ''); ?>
                                        <?php echo display('to') ?>
                                        <?php echo (!empty($ToDate) ? html_escape($ToDate) : ''); ?>)</font><strong>
                            </caption>
                            <tr class="table_data">
                                <td align="center">&nbsp;</td>
                                <td align="center">&nbsp;</td>
                                <td align="center">&nbsp;</td>
                                <td align="center">&nbsp;</td>
                                <td colspan="3" align="right"><strong><?php echo display('opening_balance') ?></strong>
                                </td>
                                <td align="right">
                            ...
                            <tr class="table_data">
                                <?php
                                    ...
                                    ?>
                                <td height="25" bgcolor="<?php echo $bg; ?>" align="center">
                                    <?php echo $CountingNo++; ?>
                                </td>
                                ...
                                <td align="center" bgcolor="<?php echo $bg; ?>">
                                    <?php echo $oResult->rows[$i]['VNo']; ?>
                                </td>
                                <td align="center" bgcolor="<?php echo $bg; ?>">
                                    <?php echo $oResult->rows[$i]['Vtype']; ?>
                                </td>
                                <?php
                                ...
                                <?php
                                    ...
                                    ?>
                                <td align="center" bgcolor="<?php echo $bg; ?>">
                                    <?php echo html_escape($oResult->rows[$i]['Narration']); ?></td>
