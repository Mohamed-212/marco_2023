            ...
            <div class="col-sm-12 col-md-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body hideme">
                        <?php echo $print_only ? '<form>' : form_open_multipart('accounting/accounting/bdtask_create_contra_voucher', 'id="validate"') ?>
                        <table>
                            <?php if ($print_only) : ?>
                        ...
                        <div class="form-group row" style="margin-top: 150px;">
                            <div class="col-sm-12 text-right footer-btns">
                                <?php if ($print_only) : ?>
                                    ...
                                    <a href="<?= base_url() . '/accounting/accounting/contra_voucher' ?>" class="btn btn-success">
                                        <?= display('add_another') ?>
                                    </a>
                                <?php else : ?>
